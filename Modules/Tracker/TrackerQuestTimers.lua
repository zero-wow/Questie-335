...
function TrackerQuestTimers:UpdateTimerFrame()
    if timer and (Questie.db.profile.trackerEnabled and Questie.db.char.isTrackerExpanded and (QuestieTracker.disableHooks ~= true)) then
        ...
        if timeRemainingString ~= nil then
            ...
            timer.frame.label:SetFont(TrackerFonts:GetObjectiveFont(), TrackerFonts:GetObjectiveFontSize(), Questie.db.profile.trackerFontOutline)
            ...
            timer.frame:SetWidth(timer.frame.label:GetWidth() + ((34) - (18 - trackerFontSizeQuest)) + trackerFontSizeQuest)
        else
