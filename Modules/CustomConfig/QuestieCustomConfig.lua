...
local function _RenderColorwaysPage(host)
    ...
    local cardGap = 5
    local firstRowTop = -8
    local shellSection = _CreateNativeSection(page, iconSection, "Interface Colorways", "Recolors the /qc shell and supplies matching alternating tracker-background colors. Applying one never changes their visibility or map colors.", 1)
