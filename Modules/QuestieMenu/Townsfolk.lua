...
local function _GetPlayerFaction()
    return UnitFactionGroup("player")
end

function Townsfolk.GetPlayerBaseClass()
    return _GetPlayerBaseClass()
end
...
function Townsfolk.PostBoot() -- post DB boot (use queries here)
    local playerClass = _GetPlayerBaseClass()
...
function Townsfolk:BuildCharacterTownsfolk()
    local playerClass = _GetPlayerBaseClass()
    local playerFaction = _GetPlayerFaction()

    Questie.db.char.townsfolk = {}
    Questie.db.char.vendorList = {}
    Questie.db.char.townsfolkClass = playerClass or ""

    for key, npcs in pairs((Questie.db.global.factionSpecificTownsfolk and Questie.db.global.factionSpecificTownsfolk[playerFaction]) or {}) do
        Questie.db.char.townsfolk[key] = npcs
    end

    for key, npcs in pairs((Questie.db.global.classSpecificTownsfolk and Questie.db.global.classSpecificTownsfolk[playerClass]) or {}) do
        Questie.db.char.townsfolk[key] = npcs
    end
end
