    ...
    return {
        ...
        args = {
            ...
            autobuy_options = {
                type = "header",
                order = 2.5,
                name = function() return l10n('Auto Buy'); end,
            },
            autobuyQuestItems = {
                type = "toggle",
                order = 2.6,
                name = function() return l10n('Auto Buy Vendor Quest Items'); end,
                desc = function() return l10n('When enabled, Questie will automatically buy vendor-sold quest items when you open a merchant. It only buys enough for the current quest step when the item can be identified safely, and it honors the Auto Modifier.'); end,
                width = 1.8,
                get = function() return Questie.db.profile.autobuyQuestItems; end,
                set = function(_, value)
                    Questie.db.profile.autobuyQuestItems = value
                    Questie:Debug(Questie.DEBUG_DEVELOP, "Auto Buy Vendor Quest Items toggled to:", value)
                end,
            },
            autobuy_spacer = QuestieOptionsUtils:Spacer(2.7),
