...
function QuestieOptions.tabs.general:Initialize()
    return {
        ...
        args = {
            ...
            route_spacer = QuestieOptionsUtils:Spacer(3.2, nil, "minimal"),
            route_options_group = {
                type = "group",
                order = 3.5,
                inline = true,
                name = function() return l10n('Routes'); end,
                args = {
                    enableRoutes = {
                        type = "toggle",
                        order = 1,
                        name = function() return l10n('Show Route Between Objectives'); end,
                        desc = function() return l10n('Draw dotted route lines between quest objectives on the world map (pfQuest style).'); end,
                        width = 1.55,
                        get = function(info) return QuestieOptions:GetProfileValue(info); end,
                        set = function(info, value) QuestieOptions:SetProfileValue(info, value); end,
                    },
                    enableRouteArrow = {
                        type = "toggle",
                        order = 2,
                        name = function() return l10n('Show Navigation Arrow'); end,
                        desc = function() return l10n('Show an on-screen arrow pointing to the nearest quest objective. Shift+drag to reposition.'); end,
                        width = 1.55,
                        get = function(info) return QuestieOptions:GetProfileValue(info); end,
                        set = function(info, value) QuestieOptions:SetProfileValue(info, value); end,
                    },
                    enableRouteCluster = {
                        type = "toggle",
                        order = 3,
                        name = function() return l10n('Include Cluster Locations'); end,
                        desc = function() return l10n('Include unified cluster objective pins in route planning.'); end,
                        width = 1.55,
                        get = function(info) return QuestieOptions:GetProfileValue(info); end,
                        set = function(info, value) QuestieOptions:SetProfileValue(info, value); end,
                    },
                    enableRouteEnder = {
                        type = "toggle",
                        order = 4,
                        name = function() return l10n('Include Quest Enders'); end,
                        desc = function() return l10n('Include quest turn-in NPCs in route planning.'); end,
                        width = 1.55,
                        get = function(info) return QuestieOptions:GetProfileValue(info); end,
                        set = function(info, value) QuestieOptions:SetProfileValue(info, value); end,
                    },
                    enableRouteStarter = {
                        type = "toggle",
                        order = 5,
                        name = function() return l10n('Include Quest Starters'); end,
                        desc = function() return l10n('Include quest giver pins in route planning.'); end,
                        width = 1.55,
                        get = function(info) return QuestieOptions:GetProfileValue(info); end,
                        set = function(info, value) QuestieOptions:SetProfileValue(info, value); end,
                    },
            ...
            level_options_group = {
                ...
                args = {
                    level_text = {
                        type = "description",
                        order = 1,
                        name = function() return Questie:Colorize(l10n('Low level available quests can be hidden here. Quests already in your log (objectives / turn-ins) are never filtered by this.'), 'gray'); end,
                        fontSize = "small",
                    },
                    ...
                    radio = {
                        ...
                        values = {
                            [Questie.LOWLEVEL_NONE] = l10n("Don't show low level quests"),
                        ...
                        set = function (_, value)
                            ...
                            -- Full note rebuild: available ! icons + in-log objectives / turn-ins / tracker
