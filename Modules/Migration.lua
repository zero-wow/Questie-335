...
local migrationFunctions = {
    ...
    [3] = function()
        -- Older profiles could bind both actions to Left Click; preserve the intended defaults.
        if Questie.db.profile.trackerbindOpenQuestLog == nil and Questie.db.profile.trackerbindSetTomTom == "left" then
            Questie.db.profile.trackerbindSetTomTom = "ctrlleft"
            Questie.db.profile.trackerbindOpenQuestLog = "left"
        end
    end
}
