...
local function ForwardCompatLibrary(target, source)
    if not source then
        return false
    end
...
if QuestieCompat and QuestieCompat.Is335 and ForwardCompatLibrary(HereBeDragons, QuestieCompat.HBD) then
    return
end
