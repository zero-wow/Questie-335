...
local trackerOptionsLocales = {
    ...
    ["Sets the color and alpha for the first, third, and following alternating rows or quest blocks."] = {
        ["ptBR"] = true,
        ["ruRU"] = true,
        ["deDE"] = true,
        ["koKR"] = true,
    ...
    ["Sets the color and alpha for the second, fourth, and following alternating rows or quest blocks."] = {
        ["ptBR"] = true,
        ["ruRU"] = true,
        ["deDE"] = true,
        ["koKR"] = true,
    ...
    ["Quest Blocks gives each quest title and all of its objectives one continuous alternating background. Individual Rows alternates every visible tracker line, including zone headers."] = {
        ["ptBR"] = true,
        ["ruRU"] = true,
        ["deDE"] = true,
        ["koKR"] = true,
    ...
    ["Extends a quest-block background into the existing space above and below its text without changing tracker layout or quest spacing."] = {
        ["ptBR"] = true,
        ["ruRU"] = true,
        ["deDE"] = true,
        ["koKR"] = true,
